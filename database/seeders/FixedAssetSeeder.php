...
class FixedAssetSeeder extends Seeder
{
    ...
    private const array FIXED_ASSETS = [
        [
            ...
            'residual_value' => '0.00',
            'current_period_depreciation_expense' => '0.00',
        ...
        [
            ...
            'residual_value' => '0.00',
            'current_period_depreciation_expense' => '0.00',
            'accumulated_depreciation' => '72000.00',
            'status' => 'held',
        ...
        [
            ...
            'residual_value' => '0.00',
            'current_period_depreciation_expense' => '0.00',
            'accumulated_depreciation' => '40000.00',
            'status' => 'held',
            'notes' => '創業者および社員の執務用家具',
        ],
        [
            'department_code' => 'D130',
            'asset_code' => 'FA-INF-OLD-001',
            'asset_name' => '旧ネットワーク機器（売却済）',
            'asset_category' => 'furniture_fixture',
            'asset_category_detail' => null,
            ...
            'accumulated_depreciation' => '120000.00',
            'status' => 'sold',
            'notes' => '2026年6月18日に100,000円で売却し、固定資産売却益20,000円を計上',
        ],
        [
            'department_code' => 'D210',
            'asset_code' => 'FA-TAB-001',
            'asset_name' => '業務用iPad（故障除却）',
            'asset_category' => 'furniture_fixture',
            'asset_category_detail' => null,
            ...
            'depreciation_method' => 'straight_line',
            'residual_value' => '0.00',
            'current_period_depreciation_expense' => '22500.00',
            'accumulated_depreciation' => '42500.00',
            'status' => 'retired',
            'notes' => '2026年9月5日に故障のため除却し、固定資産除却損77,500円を計上',
        ],
        [
            'department_code' => 'D210',
            'asset_code' => 'FA-TAB-002',
            'asset_name' => '買替用iPad',
            'asset_category' => 'furniture_fixture',
            'asset_category_detail' => null,
            'acquisition_date' => '2026-09-10',
            'service_start_date' => '2026-09-10',
            ...
            'status' => 'held',
            'notes' => '故障除却した業務用iPadの買替として2026年9月に取得',
        ],
    ];
